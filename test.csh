...
echo "#----------------------------------------------------------------------#"
echo "# pftools test 11: ./ptof -r sh3.prf F=-1.2 I=0.6 X=-1.5 B=-0.5 \"  
echo "# >! sh3.fsp ; ./2ft < R76849.seq | ./pfsearch -fy  sh3.fsp - C=5.0"
echo "#----------------------------------------------------------------------#"
./ptof -r sh3.prf F=-1.2 I=0.6 X=-1.5 B=-0.5 >! sh3.fsp ; ./2ft < R76849.seq | ./pfsearch -fy  sh3.fsp - C=5.0
